...
class CustomListTile extends StatelessWidget {
  ...
  const CustomListTile(
      ...
      required this.title,
      this.childWidget, this.trailing, this.titleColor, this.leadingColor, this.onTap});
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: SvgPicture.asset(leading,color: leadingColor??context.customTheme.iconColor,),
      title: AppText(
        text: title,
