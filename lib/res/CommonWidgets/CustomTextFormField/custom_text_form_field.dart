...
class CustomTextFormField extends StatelessWidget {
  ...
  const CustomTextFormField({
    ...
    this.readOnly = false,
    this.suffixIconColor, this.line2Color, this.line1Color, this.fillColor,  this.filled = false, this.hintTextFontSize, this.contentPadding, this.borderColor, this.controller, this.hintTextColor, this.cursorColor, this.textColor,
  }) : super(key: key);
